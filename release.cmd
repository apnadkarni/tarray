...
cd build\lib && zip -r tarray_ui.zip tarray_ui && move tarray_ui.zip .. && cd ..\..
...
cd build\lib && tar cvf tarray_ui.tar tarray_ui && gzip tarray_ui.tar && move tarray_ui.tar.gz .. && cd ..\..
